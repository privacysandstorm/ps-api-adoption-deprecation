...
-- 283 GB 1min
-- This is ran on 2024-09-01 to extract response_body (when adoption peaked and started to stagnate for most APIs)
-- too expensive to save response_body for all dates otherwise (see _do_not_run_apis-other-dates.sql)
